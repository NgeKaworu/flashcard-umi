...
import { Layout, Button, Menu, Space, Modal, Form, Radio } from 'antd';
  ...
  return (
    <Layout style={{ height: '100%' }}>
      <RecordHeader>
        ...
        <Button type="link" size="small" onClick={toggleSortVisable}>
          排序
        </Button>
        <Modal
          visible={sortVisable}
